...
export const TileSelectWrap = (props) => {
	...
	return (
		<TileWrap
			...
			style={{
				overflow: tileHoverOpacity === 1 || (selectedTile && selectedTile === props.key) ? "hidden" : "auto",
				borderRadius: tileHoverOpacity === 1 || (selectedTile && selectedTile === props.key) ? 20 * scale : 0,
			}}
			onMouseEnter={() => {
		...
		>
			...
			<SelectedOutline
				style={{
					...
					opacity: selectedTile && selectedTile === props.key ? 1 : 0,
				}}
			/>
		</TileWrap>
	);
