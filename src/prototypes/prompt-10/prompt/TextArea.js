	...
	return (
		<Input
			...
			style={{
				...
				width: "100%",
				bottom: 0,
				pointerEvents: props.scopedState === ScopedStates.CREATE ? "none" : "auto",
			}}
			animate={{
				opacity: props.scopedState === ScopedStates.CREATE ? 0 : 1,
				scale: props.scopedState === ScopedStates.CREATE ? 0.5 : 1,
				x: props.scopedState === ScopedStates.CREATE ? 12 : 0,
				y: props.scopedState === ScopedStates.CREATE ? 4 : 0,
			}}
