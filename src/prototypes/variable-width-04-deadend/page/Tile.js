...
export const Tile = ({ tile, page }) => {
	...
	const { metrics, pageScrollY } = useContext(MetricsContext);
	const {
		pageLeft,
		pageWidth,
		tileCornerRadius,
	...
	*/
	const onTileRearrangeDrag = (x, y, commit = false, isDragEnd = false) => {
		...
		y = y - pageScrollY.get() - pageMargin;
		...
		>
			<Wrap
                ...
                */
								...
								const tilePointerCenterYOffset = info.point.y - pageScrollY.get() - tileTop;
