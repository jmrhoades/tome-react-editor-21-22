...
export const RowResizeHandle = props => {
	...
	*/
	...
	//
	// TODO
	// remove vestiages of height6 and height12
	//
	...
	return (
		<ResizeHandle
			...
			onPan={(event, info) => {
				...
				let y = info.point.y - pageScrollY.get();
				...
				if (totalRowHeights + gridPoint < rowCount || gridPoint === rowMinHeight) {
		...
		>
			...
			<Indicator
				...
				transition={handleDown ? transitions.instant : transitions.instant}
				style={{
