...
//import { makeTestTomes } from "./TestTomes";
...
export const appendTileToRowInTome = (data, row, tome, width = false) => {
	...
	const tile = {
		...
		width: width,
		type: data.type,
		height6: data.height6,
		height12: data.height12,
		params: data.params,
	};
...
export const TomeProvider = ({ children }) => {
	...
	*/
	...
	const addPage = () => {
		...
		// Page
	const page = appendPageToTome(tomeData, createTheme());

	// Row
	const row = appendRowToPageInTome(page, tomeData);
